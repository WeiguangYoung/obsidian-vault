---
{"dg-publish":true,"permalink":"/devops-exercises/topics/python/solutions/sort_solution/","dg-note-properties":{}}
---
...
1. write a function that sorts the following list of list without using the `sorted()` and `.sort()`
   ...
   - mat_list = [[1, 2, 3], [2, 4, 4], [5, 5, 5\|1, 2, 3], [2, 4, 4], [5, 5, 5]] -> [[5, 5, 5], [2, 4, 4], [1, 2, 3\|5, 5, 5], [2, 4, 4], [1, 2, 3]]
