---
{"dg-publish":true,"permalink":"/knowledge/tools/DigitalGarden部署/","dg-note-properties":{}}
---


# Obsidian 数字花园部署 — Digital Garden
...
[Digital Garden](https://dg-docs.ole.dev/) 是一款 Obsidian 插件，让你在 Obsidian 内就能将笔记一键发布为数字花园。
