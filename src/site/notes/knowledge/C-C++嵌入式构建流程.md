---
{"dg-publish":true,"permalink":"/knowledge/C-C++嵌入式构建流程/","tags":["C","C++","嵌入式","Make","CMake","编译器","链接脚本","交叉编译","静态库","动态库"],"dg-note-properties":{"date":"2026-07-06","tags":["C","C++","嵌入式","Make","CMake","编译器","链接脚本","交叉编译","静态库","动态库"]}}
---
